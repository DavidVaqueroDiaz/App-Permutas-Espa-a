...
- **Seguimiento de permutas** (`src/lib/cadenas/seguimiento.ts`, tabla `seguimientos_permuta`, cron `/api/cron/seguimiento-permutas` a las 08:00 UTC): a cada persona de una cadena actual que se ha escrito en las dos direcciones con otra persona de la cadena (sin contar administradores), a los 30 días le llega el correo con un botón a su anuncio en Mi cuenta (no se marca nada desde el correo, porque los filtros de correo abren los enlaces solos). El plazo cuenta desde lo último de dos cosas: recibir el aviso de esa cadena y que ambas partes hayan escrito, así que una conversación antigua sobre otra cadena no dispara el correo. Si a esa persona ya se le preguntó por otra cadena en la que estaban las mismas personas, ese correo cuenta como propio y no se repite. Recordatorio a los 90 días y al menos 30 después del primero. Nunca más de dos.
